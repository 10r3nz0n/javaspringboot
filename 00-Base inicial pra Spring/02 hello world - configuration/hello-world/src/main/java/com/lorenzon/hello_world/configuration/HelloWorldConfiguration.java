...
public class HelloWorldConfiguration {
     ...
     * Exemplo
     * 
     * @Bean // usada dentro de @Configuration, para criar instancias de classes que não são
     * // gerenciadas pelo Spring;Combinado com @Autowired. Serão instancias Singleton.
